...
INSERT INTO `acore_string` (entry, content_default) VALUES (40000, 'Sold %dx %s for %d copper.');
INSERT INTO `acore_string` (entry, content_default) VALUES (40001, 'Sold a total of %d item(s) for %d copper.');
